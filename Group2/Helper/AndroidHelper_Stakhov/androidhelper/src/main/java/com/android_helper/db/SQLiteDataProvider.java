...
public class SQLiteDataProvider extends ContentProvider {
    ...
    private static UriMatcher buildUriMatcher() {
        ...
        sUriMatcher.addURI(SQLiteContract.CONTENT_AUTHORITY, SQLiteContract.Items.TB_ITEMS, ITEMS);
        sUriMatcher.addURI(SQLiteContract.CONTENT_AUTHORITY, SQLiteContract.Items.TB_ITEMS + "/*", ITEMS_ID);
        return sUriMatcher;
    }
